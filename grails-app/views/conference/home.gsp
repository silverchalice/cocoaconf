...
<div class="content container">
  ...
  <div class="row-fluid">
    <div class="span7">
      <h1>Join us in ${conference?.cityNickname} for ${conference.description.endsWith(" 2014") ? conference.description.minus(" 2014") : conference.description} <small>${conference?.dates}</small></h1>
