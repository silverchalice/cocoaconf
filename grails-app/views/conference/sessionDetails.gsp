...
<div class="content container">
  ...
  <div class="row-fluid">
    ...
    <div class="span8">
      <ul class="media-list">
        <li class="media"> <a href="#" class="pull-left"> <img class="media-object img-circle" width="170" src="${speaker.imagePath?.startsWith('/') ? speaker.imagePath : '/' + speaker.imagePath}" alt="Speaker photo" /> </a>
          <div class="media-body">
