	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.choice}">
				<li class="fieldcontain">
					<span id="choice-label" class="property-label"><g:message code="user.choice.label" default="Choice" /></span>
					
						<span class="property-value" aria-labelledby="choice-label"><g:link controller="sessionChoice" action="show" id="${userInstance?.choice?.id}">${userInstance?.choice?.encodeAsHTML()}</g:link></span>
