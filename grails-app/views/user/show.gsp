            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.sessions.label" default="Sessions" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${userInstance.sessions}" var="s">
                                    <li><g:link controller="sessionChoice" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.street.label" default="Street" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "street")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.zip.label" default="Zip" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "zip")}</td>
