            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="venue.description.label" default="Description" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: venueInstance, field: "description")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="venue.website.label" default="Website" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: venueInstance, field: "website")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="venue.address.label" default="Address" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: venueInstance, field: "address")}</td>
