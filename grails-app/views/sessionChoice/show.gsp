            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="sessionChoice.sessionId.label" default="Session Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: sessionChoiceInstance, field: "sessionId")}</td>
