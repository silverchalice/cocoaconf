...
<html>
  ...
  <br/>
  <h2>Holiday Inn Elk Grove Village</h2>
  <p><img src="${resource(dir:'images', file:'jqg_1305143227.jpg')}" style="float:left; margin:0 10px 10px 0" />CocoaConf will be held in the conference facilities of the <a href="http://www.hielkgrove.com">Holiday Inn Elk Grove Village</a><br/>
     <span class="address">1000 Busse Road, Elk Grove Village, IL 60007</span></p>
<p>CocoaConf attendees are eligible for the amazing rate of $72 per night!  Call (847) 437-6010 and tell them you're attending CocoaConf.</p><img src="${resource(dir:'images', file:'jqg_1301008015.jpg')}" style="float:right; clear:both; margin:0 10px 10px 0" /><br/><p>Along with great conference facilities, the Holiday Inn Elk Grove has very comfortable, well appointed guest rooms, plenty of free parking and a free shuttle to and from Chicago's O'Hare Airport.</p>
