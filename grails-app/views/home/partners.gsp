...
<div id="sponsors">
    ...
    <div id="mmc" class="sponsor" style="height:100px">
        <p><a href="http://macminicolo.net"><img src="${resource(dir: 'images', file: 'macminicolo.png')}"
                                                 style="float: right; padding-left:8px;"/></a>
    ...
    <div id="5by5" class="sponsor" style="height:110px">
        <p><a href="http://www.5by5.tv"><img src="${resource(dir: 'images', file: '5by5.png')}"
            ...
            <a href="http://5by5.tv">5by5</a> is an Internet broadcasting network, home to <a
                ...
                href="http://5by5.tv/pipeline">The Pipeline</a>, <a
                href="http://5by5.tv/buildanalyze">Build and Analyze</a>, and <a
                href="http://5by5.tv/broadcasts">more</a>, with hosts including <a
                href="http://5by5.tv/person/dan-benjamin">Dan Benjamin</a>, <a
                href="http://5by5.tv/person/john-gruber">John Gruber</a>, <a
                href="http://5by5.tv/person/merlin-mann">Merlin Mann</a>, <a
                href="http://5by5.tv/person/jeffrey-zeldman">Jeffrey Zeldman</a>, and <a
                href="http://5by5.tv/person/marco-arment">Marco Arment</a>.</p>
    </div>

    <div style="clear: both">
        <a href="http://www.manning.com/"><img src="${resource(dir: 'images', file: 'manning.png')}"
                                               style="margin-left:15px; float:left;"/></a>
        <a href="http://wiley.com"><img src="${resource(dir: 'images', file: 'wiley.jpg')}"
                                        style="margin-top:15px;width:300px; height:auto"/></a>
        <a href="http://informit.com/learnmac"><img src="${resource(dir: 'images', file: 'Addison-Wesley.jpg')}"
                                                    style="margin-top:15px;width:550px; height:auto"/></a>
    </div>
</div>

<div style="clear: both; padding-top: 20px;"><p>For more information about becoming a CocoaConf sponsor, drop us a line at <a
        href="mailto:info@cocoaconf.com">info@cocoaconf</a></p></div>
