  ...
  <div class="container">
    ...
    <div class="row-fluid">
      <div class="span2"> <g:link controller="conference" action="home" params="['tinyName': 'chicago-2014']">
        ...
        <g:link controller="conference" action="register" params="['tinyName': 'chicago-2014']" class="btn btn-flat-gray btn-large" title="Register for this city">Waitlist <i class="ion-ios7-arrow-forward hidden-tablet"></i></g:link> </div>
