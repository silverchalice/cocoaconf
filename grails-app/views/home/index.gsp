  ...
  <div class="container">
    <div class="media"> <img src="${resource(dir: 'images', file: useImg > 75 ? 'img_imac.png' : 'img_iphone_c.png')}" alt="${useImg > 75 ? 'An iMac' : 'An iPhone 5c'}" class="pull-right ${useImg > 75 ? 'imac' : 'iphone'}"></a>
      <div class="media-body">
        ...
        <p class="lead">Short description of the conference goes here. Venenatis morbi blandit elit sollicitudin mollis cursus magna justo enim duis senectus cubilia rutrum luctus augue volutpat pretium pellentesque nisl lacus diam.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="row-fluid">
      <div class="span2"> <a href="#">
        ...
        <a href="#" class="btn btn-flat-gray btn-large" title="Register for this city">Register <i class="ion-ios7-arrow-forward hidden-tablet"></i></a> </div>
      <div class="span2"> <a href="#">
...
<div class="speakers">
  <div class="container">
    ...
    <p class="lead text-center">CocoaConf speakers are thought leaders, authors, and professional iOS and OS X developers. <a href="#" title="All speakers">Meet them all <i class="ion-ios7-arrow-forward"></i></a></p>
    <p>&nbsp;</p>
    <div class="row-fluid">
      ...
      <div class="span2"> <a href="#" title="Learn more about this speaker"><img class="img-circle center" src="${resource(dir: 'images', file: 'photo_speaker.jpg')}" alt="Speaker image"></a>
...
<div class="sessions">
  <div class="container">
    ...
    <div class="row-fluid">
      <div class="span5">
        <div class="media"> <a href="#" title="Learn more" class="pull-left hidden-tablet"><img src="${resource(dir: 'images', file: 'img_session_home_01.png')}" alt="Speaker image"></a>
          <div class="media-body">
      ...
      <div class="span5">
        <div class="media"> <a href="#" title="Learn more" class="pull-left hidden-tablet"><img src="${resource(dir: 'images', file: 'img_session_home_02.png')}" alt="Speaker image"></a>
          <div class="media-body">
