...
<html>
    ...
    <sec:ifNotLoggedIn>
        <div id="announcementHeader" style="width:100%; background-image:url(${resource(dir:'images', file:'bar-bg.png')}); text-align:center; height:25px; padding-top:8px; margin-bottom:10px; font-weight:bold; color:white">Coming December, 2011 to North Carolina! - <span style="color:#ff9627">Registration opening soon.</span> <span style="color:white; margin-left: 10px; padding-left: 10px; border-left: 1px solid gray "><g:link style="text-decoration: none; color:#2ab0e2;" controller="login" > Login</g:link></span>  </div>
    </sec:ifNotLoggedIn>
    <sec:ifLoggedIn>
