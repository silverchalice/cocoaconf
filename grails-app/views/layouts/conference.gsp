    ...
    <body id="announcement">
        <div id="navWrapper">
            <div id="nav">
                ...
                <g:link controller="home" action="about" style="background-position: -100px 0;">About</g:link>
                <g:link controller="post" action="list" style="background-position: -200px 0;">Blog</g:link>
                <g:link controller="speaker" action="speakers" style="background-position: -300px 0;">Our Speakers</g:link>
                <g:link controller="home" action="partners" style="background-position: -400px 0;">Our Partners</g:link>
